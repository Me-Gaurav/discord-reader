...
| Options w/ DTE (Clint/Altori) | `$NVDA 222.5 CALL 0DTE @1.00` | 0DTE = today (warns), `@` premium |
| Exit | `NVDA 215c TRIMMED AT 44%`, `AAPL 315C ALL OUT AT 226%`, `✂️ $NVDA 222.5c +22%` | sell-to-close a matching held position |
